         ...
         unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 d1 1f 80 00 	movsbl 0x801fd1(%eax),%eax
...
reswitch:
  ...
  800363:	ff 24 8d 20 21 80 00 	jmp    *0x802120(,%ecx,4)
...
reswitch:
  ...
  80042f:	c7 44 24 08 f2 1f 80 	movl   $0x801ff2,0x8(%esp)
  800436:	00 
...
reswitch:
  ...
  800461:	b8 e2 1f 80 00       	mov    $0x801fe2,%eax
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80163b:	c7 44 24 04 98 23 80 	movl   $0x802398,0x4(%esp)
  801642:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801701:	c7 04 24 9f 23 80 00 	movl   $0x80239f,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019c0:	c7 44 24 04 b7 23 80 	movl   $0x8023b7,0x4(%esp)
  8019c7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b82:	c7 04 24 c4 23 80 00 	movl   $0x8023c4,(%esp)
  ...
  cprintf("\n");
  801b9d:	c7 04 24 b0 23 80 00 	movl   $0x8023b0,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801beb:	c7 44 24 08 e8 23 80 	movl   $0x8023e8,0x8(%esp)
  801bf2:	00 
  801bf3:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  801bfa:	00 
  801bfb:	c7 04 24 f9 23 80 00 	movl   $0x8023f9,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c59:	c7 44 24 08 03 24 80 	movl   $0x802403,0x8(%esp)
  801c60:	00 
  801c61:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  801c68:	00 
  801c69:	c7 04 24 f9 23 80 00 	movl   $0x8023f9,(%esp)
