...
exit(void)
{
  ...
  close_all();
  80009d:	e8 23 05 00 00       	call   8005c5 <close_all>
  sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800132:	e8 0f 10 00 00       	call   801146 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ac:	00 
  8001ad:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8001b4:	00 
  8001b5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001bc:	00 
  8001bd:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8001c4:	e8 7d 0f 00 00       	call   801146 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ff:	00 
  800200:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800207:	00 
  800208:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020f:	00 
  800210:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800217:	e8 2a 0f 00 00       	call   801146 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800252:	00 
  800253:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  80025a:	00 
  80025b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800262:	00 
  800263:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  80026a:	e8 d7 0e 00 00       	call   801146 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a5:	00 
  8002a6:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8002ad:	00 
  8002ae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b5:	00 
  8002b6:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8002bd:	e8 84 0e 00 00       	call   801146 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f8:	00 
  8002f9:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800300:	00 
  800301:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800308:	00 
  800309:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800310:	e8 31 0e 00 00       	call   801146 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80034b:	00 
  80034c:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  800353:	00 
  800354:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80035b:	00 
  80035c:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  800363:	e8 de 0d 00 00       	call   801146 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003c0:	00 
  8003c1:	c7 44 24 08 ca 1f 80 	movl   $0x801fca,0x8(%esp)
  8003c8:	00 
  8003c9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003d0:	00 
  8003d1:	c7 04 24 e7 1f 80 00 	movl   $0x801fe7,(%esp)
  8003d8:	e8 69 0d 00 00       	call   801146 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004c5:	ba 74 20 80 00       	mov    $0x802074,%edx
  int i;
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004f5:	c7 04 24 f8 1f 80 00 	movl   $0x801ff8,(%esp)
  ...
  80052c:	c1 e8 0c             	shr    $0xc,%eax
{
  ...
  800584:	e8 9b fc ff ff       	call   800224 <sys_page_unmap>
  return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800682:	e8 4a fb ff ff       	call   8001d1 <sys_page_map>
  ...
  8006bd:	e8 0f fb ff ff       	call   8001d1 <sys_page_map>
...
err:
  ...
  8006d6:	e8 49 fb ff ff       	call   800224 <sys_page_unmap>
  sys_page_unmap(0, nva);
  8006db:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8006df:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8006e6:	e8 39 fb ff ff       	call   800224 <sys_page_unmap>
  return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80074a:	c7 04 24 39 20 80 00 	movl   $0x802039,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800822:	c7 04 24 55 20 80 00 	movl   $0x802055,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008db:	c7 04 24 18 20 80 00 	movl   $0x802018,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c2b:	c7 44 24 04 84 20 80 	movl   $0x802084,0x4(%esp)
  800c32:	00 
  ...
  800c4d:	00 00 00 
  stat->st_dev = &devpipe;
  800c50:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  800c57:	30 80 00 
  return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  800c7b:	e8 a4 f5 ff ff       	call   800224 <sys_page_unmap>
  ...
  800c93:	e8 8c f5 ff ff       	call   800224 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800cf1:	c7 04 24 8b 20 80 00 	movl   $0x80208b,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800d2f:	75 41                	jne    800d72 <devpipe_write+0x6b>
      ...
      sys_yield();
  800d31:	e8 28 f4 ff ff       	call   80015e <sys_yield>
    cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
            thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800daf:	75 31                	jne    800de2 <devpipe_read+0x63>
      ...
      sys_yield();
  800db1:	e8 a8 f3 ff ff       	call   80015e <sys_yield>
    cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
            thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800e22:	e8 56 f3 ff ff       	call   80017d <sys_page_alloc>
  ...
  800e5c:	e8 1c f3 ff ff       	call   80017d <sys_page_alloc>
  ...
  800e8b:	e8 ed f2 ff ff       	call   80017d <sys_page_alloc>
  ...
  800ec4:	e8 08 f3 ff ff       	call   8001d1 <sys_page_map>
  ...
  800ecf:	8b 15 20 30 80 00    	mov    0x803020,%edx
  ...
  800ee4:	8b 15 20 30 80 00    	mov    0x803020,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fb0:	c7 44 24 04 a3 20 80 	movl   $0x8020a3,0x4(%esp)
  800fb7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80100d:	e8 9e f0 ff ff       	call   8000b0 <sys_cputs>
  int tot, m;
  char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  while ((c = sys_cgetc()) == 0)
    sys_yield();
  801039:	e8 20 f1 ff ff       	call   80015e <sys_yield>
  int c;
  ...
  801040:	e8 89 f0 ff ff       	call   8000ce <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80107f:	e8 2c f0 ff ff       	call   8000b0 <sys_cputs>
}
  801084:	c9                   	leave  
  801085:	c3                   	ret    
...
opencons(void)
{
  ...
  801118:	e8 60 f0 ff ff       	call   80017d <sys_page_alloc>
    return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801157:	e8 e3 ef ff ff       	call   80013f <sys_getenvid>
  ...
  801172:	c7 04 24 b0 20 80 00 	movl   $0x8020b0,(%esp)
  ...
  cprintf("\n");
  80118d:	c7 04 24 9c 20 80 00 	movl   $0x80209c,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8011c9:	e8 e2 ee ff ff       	call   8000b0 <sys_cputs>
    b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801232:	e8 79 ee ff ff       	call   8000b0 <sys_cputs>
         ...
         unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801338:	0f be 80 d3 20 80 00 	movsbl 0x8020d3(%eax),%eax
...
reswitch:
  ...
  8014ff:	c7 44 24 08 eb 20 80 	movl   $0x8020eb,0x8(%esp)
  801506:	00 
  ...
  80151f:	c7 44 24 08 f4 20 80 	movl   $0x8020f4,0x8(%esp)
  801526:	00 
...
reswitch:
  ...
  801551:	b8 e4 20 80 00       	mov    $0x8020e4,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bd4:	e8 ba e7 ff ff       	call   800393 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c7a:	e8 c7 f4 ff ff       	call   801146 <_panic>
    sys_yield();
  801c7f:	e8 da e4 ff ff       	call   80015e <sys_yield>
  // LAB 4: Your code here.
  int r;
  ...
  801c96:	e8 d5 e6 ff ff       	call   800370 <sys_ipc_try_send>
