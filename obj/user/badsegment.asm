...
exit(void)
{
  ...
  close_all();
  80008c:	e8 24 05 00 00       	call   8005b5 <close_all>
  sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800109:	00 
  80010a:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  800111:	00 
  800112:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800119:	00 
  80011a:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  800121:	e8 10 10 00 00       	call   801136 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019b:	00 
  80019c:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  8001a3:	00 
  8001a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ab:	00 
  8001ac:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  8001b3:	e8 7e 0f 00 00       	call   801136 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ee:	00 
  8001ef:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  8001f6:	00 
  8001f7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fe:	00 
  8001ff:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  800206:	e8 2b 0f 00 00       	call   801136 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800241:	00 
  800242:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  800249:	00 
  80024a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800251:	00 
  800252:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  800259:	e8 d8 0e 00 00       	call   801136 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800294:	00 
  800295:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  80029c:	00 
  80029d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a4:	00 
  8002a5:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  8002ac:	e8 85 0e 00 00       	call   801136 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e7:	00 
  8002e8:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  8002ef:	00 
  8002f0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f7:	00 
  8002f8:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  8002ff:	e8 32 0e 00 00       	call   801136 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033a:	00 
  80033b:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  800342:	00 
  800343:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034a:	00 
  80034b:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  800352:	e8 df 0d 00 00       	call   801136 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003af:	00 
  8003b0:	c7 44 24 08 aa 1f 80 	movl   $0x801faa,0x8(%esp)
  8003b7:	00 
  8003b8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bf:	00 
  8003c0:	c7 04 24 c7 1f 80 00 	movl   $0x801fc7,(%esp)
  8003c7:	e8 6a 0d 00 00       	call   801136 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003d2:	5d                   	pop    %ebp
  8003d3:	c3                   	ret    
  8003d4:	66 90                	xchg   %ax,%ax
  8003d6:	66 90                	xchg   %ax,%ax
  ...
  80051c:	c1 e8 0c             	shr    $0xc,%eax
{
  ...
  800574:	e8 9a fc ff ff       	call   800213 <sys_page_unmap>
  return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800672:	e8 49 fb ff ff       	call   8001c0 <sys_page_map>
  ...
  8006ad:	e8 0e fb ff ff       	call   8001c0 <sys_page_map>
...
err:
  ...
  8006c6:	e8 48 fb ff ff       	call   800213 <sys_page_unmap>
  sys_page_unmap(0, nva);
  8006cb:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8006cf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8006d6:	e8 38 fb ff ff       	call   800213 <sys_page_unmap>
  return r;
...
devpipe_close(struct Fd *fd)
{
  ...
  800c6b:	e8 a3 f5 ff ff       	call   800213 <sys_page_unmap>
  ...
  800c83:	e8 8b f5 ff ff       	call   800213 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800d1f:	75 41                	jne    800d62 <devpipe_write+0x6b>
      ...
      sys_yield();
  800d21:	e8 27 f4 ff ff       	call   80014d <sys_yield>
    cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
            thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800d9f:	75 31                	jne    800dd2 <devpipe_read+0x63>
      ...
      sys_yield();
  800da1:	e8 a7 f3 ff ff       	call   80014d <sys_yield>
    cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
            thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800e12:	e8 55 f3 ff ff       	call   80016c <sys_page_alloc>
  ...
  800e4c:	e8 1b f3 ff ff       	call   80016c <sys_page_alloc>
  ...
  800e7b:	e8 ec f2 ff ff       	call   80016c <sys_page_alloc>
  ...
  800eb4:	e8 07 f3 ff ff       	call   8001c0 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800ffd:	e8 9d f0 ff ff       	call   80009f <sys_cputs>
  int tot, m;
  char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  while ((c = sys_cgetc()) == 0)
    sys_yield();
  801029:	e8 1f f1 ff ff       	call   80014d <sys_yield>
  int c;
  ...
  801030:	e8 88 f0 ff ff       	call   8000bd <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80106f:	e8 2b f0 ff ff       	call   80009f <sys_cputs>
}
  801074:	c9                   	leave  
  801075:	c3                   	ret    
...
opencons(void)
{
  ...
  801108:	e8 5f f0 ff ff       	call   80016c <sys_page_alloc>
    return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801147:	e8 e2 ef ff ff       	call   80012e <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8011b9:	e8 e1 ee ff ff       	call   80009f <sys_cputs>
    b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801222:	e8 78 ee ff ff       	call   80009f <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bc4:	e8 b9 e7 ff ff       	call   800382 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c6a:	e8 c7 f4 ff ff       	call   801136 <_panic>
    sys_yield();
  801c6f:	e8 d9 e4 ff ff       	call   80014d <sys_yield>
  // LAB 4: Your code here.
  int r;
  ...
  801c86:	e8 d4 e6 ff ff       	call   80035f <sys_ipc_try_send>
